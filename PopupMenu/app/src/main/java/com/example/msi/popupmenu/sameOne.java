...
public class sameOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_same_one);
        ...
        categories.add(new Category("Game",gameList));
        categories.add(new Category("Game",gameList));
        categories.add(new Category("Game",gameList));
        categories.add(new Category("Game",gameList));
        categories.add(new Category("Game",gameList));
        ...
        SameOneAdapter sameOneAdapter = new SameOneAdapter(this,categories,R.layout.item_two_layout);
        recyclerView.setAdapter(sameOneAdapter);
    }
}
